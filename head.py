...
#Importing "head" "readfile" functions from helper library using "from" "import" keywords
TEXT = None
...
print(head(TEXT))
#print the function head containing TEXT as an argument
#it will print top ten lines in the file
