...
#if the value of ARG_CNT varialble is one, the condition will be true. This makes to execute the next line
...
print(cat(TEXT))
#print the function cat containing TEXT as an argument
#it will print all the lines in the file from top to bottom
